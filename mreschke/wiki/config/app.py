...
config = {
    ...
    'middleware': OrderedDict({
        'TrustedHost': {
            'module': 'starlette.middleware.trustedhost.TrustedHostMiddleware',
        },
        'HTTPSRedirect': {
            'module': 'starlette.middleware.httpsredirect.HTTPSRedirectMiddleware',
            'options': {
                'allowed_hosts': ['example.com', '*.example.com']
            }
        },
        'CORSMiddleware': {
            'module': 'starlette.middleware.cors.CORSMiddleware',
            'options': {
                'allow_origins': ['*'],
                'allow_methods': ['GET', 'POST'],
            }
